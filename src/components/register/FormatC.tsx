...
export function FormatC({ projectId, scenarioType, currentLayer, onSaved, onNextStep, initialData, step, isReviewing }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {step === 0 && (
        <div>
          <p className="text-small text-op-gray mb-1">Quadro 1 — Fatos observados</p>
      ...
      {step === 1 && (
        <div>
          <p className="text-small text-op-gray mb-1">Quadro 2 — Interpretações</p>
      ...
      {step === 2 && (
        <div>
          <p className="text-small text-op-gray mb-1">Quadro 3 — Hipóteses testáveis</p>
